...
import com.gaurav.foodapp.fragment.LoginFragment
...
class LoginRegisterActivity : AppCompatActivity() {
    ...
    override fun onBackPressed() {
        val currentFragment = supportFragmentManager.findFragmentById(R.id.frameLayout)//gets the id of the current fragment
